...
class partition_handlerton : public handlerton
{
public:
  partition_handlerton();
};

partition_handlerton::partition_handlerton()
{
  this->db_type= DB_TYPE_PARTITION_DB;
  this->create= partition_create_handler;
  this->partition_flags= ::partition_flags;
  this->alter_table_flags= ::alter_table_flags;
  this->flags= HTON_NOT_USER_SELECTABLE |
               HTON_HIDDEN |
               HTON_TEMPORARY_NOT_SUPPORTED;
  this->tablefile_extensions= ha_partition_ext;
}
