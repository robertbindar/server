...
class User_table_json: public User_table
{
  ...
  my_time_t get_password_last_changed () const
  { return get_int_value("password_last_changed"); }
  int set_password_last_changed (const my_time_t &x) const
  { return set_int_value("password_last_changed", x); }
  int set_password_lifetime (longlong x) const
                                       ...
                                       ACL_USER *user)
{
  ...
  user_table.set_password_last_changed(now);
                              ...
                              bool can_create_user, bool no_auto_create)
{
  ...
  else
  {
    ...
    case PASSWORD_EXPIRE_DEFAULT:
      user_table.set_password_lifetime(-1);
      new_acl_user.password_lifetime= -1;
      break;
