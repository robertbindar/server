...
class mrn_handlerton : public handlerton
{
public:
  mrn_handlerton();
};
...
{
  this->create = mrn_handler_create;
  this->flags = HTON_NO_FLAGS;
#ifndef MRN_SUPPORT_PARTITION
  this->flags |= HTON_NO_PARTITION;
#endif
  this->drop_database = mrn_drop_database;
  this->close_connection = mrn_close_connection;
  this->flush_logs = mrn_flush_logs;
#ifdef MRN_HAVE_HTON_ALTER_TABLE_FLAGS
  this->alter_table_flags = mrn_alter_table_flags;
#endif
#ifdef MRN_SUPPORT_CUSTOM_OPTIONS
  this->field_options = mrn_field_options;
  this->index_options = mrn_index_options;
#endif
}
