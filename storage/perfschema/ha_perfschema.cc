...
class pfs_handlerton : public handlerton
{
public:
  pfs_handlerton();
};

pfs_handlerton::pfs_handlerton()
{
  this->create= pfs_create_handler;
  this->show_status= pfs_show_status;
  ...
  */
  this->db_type= DB_TYPE_PERFORMANCE_SCHEMA;
  this->discover_table= pfs_discover_table;
  this->discover_table_existence= pfs_discover_table_existence;
  this->discover_table_names= pfs_discover_table_names;
}
